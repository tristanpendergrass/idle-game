...
setByKindResource : Resource -> value -> ResourceRecord value -> ResourceRecord value
...
getByKindSkill : Skill -> SkillRecord weathermancing -> weathermancing
getByKindSkill kind data =
    case kind of
        Chores ->
            data.chores
...
setByKindSkill : Skill -> value -> SkillRecord value -> SkillRecord value
setByKindSkill kind value data =
    case kind of
        Chores ->
            { data | chores = value }
...
getByKindActivity : Activity -> ActivityRecord studyWeather1 -> studyWeather1
getByKindActivity kind data =
    case kind of
        CleanStables ->
            data.cleanStables
...
setByKindActivity : Activity -> value -> ActivityRecord value -> ActivityRecord value
setByKindActivity kind value data =
    case kind of
        CleanStables ->
...
getByKindSpell : Spell -> SpellRecord weather1 -> weather1
getByKindSpell kind data =
    case kind of
        Hex1 ->
            data.hex1
...
setByKindSpell : Spell -> value -> SpellRecord value -> SpellRecord value
setByKindSpell kind value data =
    case kind of
        Hex1 ->
            { data | hex1 = value }
...
getByKindLocation : Location -> LocationRecord secretGarden -> secretGarden
getByKindLocation kind data =
    case kind of
        SchoolGrounds ->
            data.schoolGrounds
...
setByKindLocation : Location -> value -> LocationRecord value -> LocationRecord value
setByKindLocation kind value data =
    case kind of
        SchoolGrounds ->
...
getByKindMonster : Monster -> MonsterRecord whisperingWind -> whisperingWind
getByKindMonster kind data =
    case kind of
        Prefect ->
            data.prefect
...
setByKindMonster : Monster -> value -> MonsterRecord value -> MonsterRecord value
setByKindMonster kind value data =
    case kind of
        Prefect ->
            { data | prefect = value }
...
getByKindShopUpgrade : ShopUpgrade -> ShopUpgradeRecord oversizedBag -> oversizedBag
getByKindShopUpgrade kind data =
    case kind of
        Shovel ->
            data.shovel
...
setByKindShopUpgrade : ShopUpgrade -> value -> ShopUpgradeRecord value -> ShopUpgradeRecord value
setByKindShopUpgrade kind value data =
    case kind of
        Shovel ->
            { data | shovel = value }
...
getByKindQuest : Quest -> QuestRecord chopFirewood -> chopFirewood
getByKindQuest kind data =
    case kind of
        MendCrackedBell ->
...
setByKindQuest : Quest -> value -> QuestRecord value -> QuestRecord value
setByKindQuest kind value data =
    case kind of
        MendCrackedBell ->
