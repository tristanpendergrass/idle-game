...
renderContent model game activeTab =
    ...
    in
    div [ class "drawer-content t-column overflow-y-auto bg-neutral", attribute "style" "scroll-behavior:smooth; scroll-padding-top: 5rem", IdleGame.Views.Utils.zIndexes.drawerContent ]
